...
class OnixController:
    ...
    def run_experiment(self, template_path, run_duration=30):
        """
...
def process_actions_toml(toml_path, onix_controller):
    ...
    try:
        ...
        success = onix_controller.run_experiment(template_path, run_duration=30)
        ...
        try:
            ...
            if os.path.exists(actions_path):
                ...
                if process_actions_toml(actions_path, onix):
                    ...
                    log(f"Failed to process {actions_path}, will retry next cycle")
