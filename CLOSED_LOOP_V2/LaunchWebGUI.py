...
_CONFIG_PATH = os.path.join(_V6_DIR, "config.json")
...
app = Flask(
    __name__,
    template_folder=os.path.join(_V6_DIR, "templates"),
    static_folder=os.path.join(_V6_DIR, "static"),
)
